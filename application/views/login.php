...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | Tecnotronix ' . $this->config->item('application_version')  . ' | ' .  $this->lang->line('login_login'); ?></title>
...
<body>
	...
	<div id="login">
		...
		<h1>TecnoTronix Point of sale <?php echo $this->config->item('application_version'); ?></h1>
